...
struct route_setting default_input[] = {
    ...
    { .ctl_name = "DAC1L Mixer Right Sidetone Switch", .intval = 0, },
    { .ctl_name = "DAC1R Mixer Right Sidetone Switch", .intval = 0, },
    { .ctl_name = "DAC1 Right Sidetone Volume", .intval = 0, },
    { .ctl_name = "DAC1 Left Sidetone Volume", .intval = 0, },
...
struct route_setting headset_input[] = {
    ...
    { .ctl_name = "DAC1 Right Sidetone Volume", .intval = 0, },
    { .ctl_name = "DAC1 Left Sidetone Volume", .intval = 0, },
    { .ctl_name = "IN1R Volume", .intval = 18, },
    { .ctl_name = "MIXINR IN1R Volume", .intval = 0, },
